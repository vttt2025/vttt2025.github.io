...
const GRAMMAR_LESSONS = [
  ...
  },
  {
    ...
    questions: [
      ...
      { q: "Анта учится в ___. (университет)", options: ["университет", "университете", "университета", "университету"], a: 1, ex: "в университете." }
    ]
  },
  {
    id: "motion",
  ...
  },
  {
    ...
    questions: [
      ...
      { q: "Завтра я ___ чемодан.", options: ["соберу", "собираю", "собирал", "собирал"], a: 0, ex: "Tương lai một lần → СВ: соберу." },
